        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <img src="/assets/uploads/{{auth()->user()->avatar?auth()->user()->avatar:'avatar.png'}}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <img src="/assets/uploads/{{auth()->user()->avatar?auth()->user()->avatar:'avatar.png'}}" class="img-circle" alt="User Image">                               
                            <p>
                               {{auth () -> user () -> username}}
